...
module.exports = class NotificationsStatusView {
    ...
    render() {
      ...
      this.number.addEventListener('animationend', this.animationend);
    ...
    addNotification(notification) {
      this.tooltip.dispose();
      this.tooltip = atom.tooltips.add(this.element, {title: notification.getMessage()});
    ...
    clear() {
      ...
      this.tooltip.dispose();
      this.tooltip = atom.tooltips.add(this.element, {title: "No Notifications"});
    }
  };
